...
<link rel="stylesheet" href="css/dash.css">
  ...
  <body>
    ...
    $sql="SELECT * FROM `student` WHERE `student_id`='$prop_id';";
...
if(isset($_POST["submit"])) {
  ...
  $san="UPDATE student SET name ='$newname' , dob='$newdob' , gender='$newgender' , adress='$newadress'  WHERE `student_id`='$prop_id'" ;
